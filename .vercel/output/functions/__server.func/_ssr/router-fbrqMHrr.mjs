...
import { n as Sparkles, t as TriangleAlert } from "../_libs/lucide-react.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/router-fbrqMHrr.js
...
var timeline = [
	{
		...
		org: "汇量科技",
		title: "海外大型项目视觉",
		note: "PUBG、影之刃零、喵将三国、Cash Casino、拉斯海马旅游局等，多语言多媒介售卖创意。"
	},
	{
		period: "2024.08 — 2025",
		org: "腾娱互动 / 腾讯",
		title: "元梦之星 GUI",
		note: "发现 / 祈愿 / 热购主题活动、常规换皮、按钮 Icon、拍脸图与 Banner。"
	},
	{
		period: "2023.01 — 2024.06",
		org: "奥帕云 · 伴伴系产品",
		title: "视觉设计师",
		note: "礼物座驾霸屏、运营 H5、AIGC 增效，覆盖谁是凶手 / 皮队友 / VEEKA 等。"
	},
	{
		period: "2019.07 — 2022.10",
		org: "字节跳动",
		title: "视觉设计师（兼管理）",
		note: "信息流广告、手绘长图、投放剪辑；8 次月度优秀，带教与 SOP 建设。"
	}
];
var stats = [
	{
...
var categories = [
	{
		...
		blurb: "海外售卖创意、品牌物料与内部产品化设计。多语言、多场景、多媒介。"
	},
	{
		id: "ops",
		no: "02",
	...
	},
	{
		...
		en: "Game GUI",
		tint: "var(--color-cyan)",
		blurb: "元梦之星界面手搓：主题换皮、拍脸图、Icon 与走查验收。"
	},
	{
		id: "growth",
		no: "04",
		...
		en: "Growth / Feed",
		tint: "var(--color-hot)",
		blurb: "电商图、长图信息架构、投放向视频。用视觉服务消耗与转化。"
	},
	{
		id: "ai",
		no: "05",
	...
	},
	{
		...
		blurb: "插画长图、招生系列、扁平场景与 C4D 造型探索。"
	}
];
var projects = [
	{
		...
		category: "brand",
		title: "汇量科技 · 海外大型项目视觉售卖",
		en: "Global Brand Selling",
		year: "2025 — 2026",
		client: "汇量科技",
		featured: true,
		cover: null,
		...
		summary: "负责海外大型项目视觉售卖，覆盖游戏 / 旅游 / 工具 / 电商 / 教育 / 社交等多赛道。创意输出平面 + 视频，支持多语言、多场景、多媒介，并辅助代投业务与单体信息流客户。",
		role: "视觉统筹 / 平面 + 视频创意",
		recap: "海外售卖的核心不是单张好看，而是同一套创意在多市场、多尺寸、多语言里还能打。当前以项目推进与创意框架为主，完整视觉成片将持续更新进作品集。",
		outcome: "多赛道并行，平面与视频同步供给投放。"
	},
	{
		slug: "yumeng-gui",
		category: "game",
		...
		summary: "负责元梦之星发现 / 祈愿 / 热购等区域的主题活动与常规界面换皮，包含按钮、Icon、拍脸图与 Banner 的设计输出及验收走查。",
		role: "GUI 设计 / 走查验收",
		recap: "换皮不是套皮。要在既有组件骨架上把主题情绪做满，同时保证热区、层级和资源规范能过研发验收。个人信息页尝试了两套完全不同的装饰语言，验证同一信息结构的风格延展上限。",
	...
	},
	{
		...
		summary: "国内社交产品重要节点运营。年度盛典从主视觉、活动主页、榜单、房间到按钮弹窗完整铺开，紫蓝赛博质感统一全链路。",
		role: "活动视觉主设计",
		recap: "节点活动要先把「盛典感」做足，再把玩法模块嵌进去。奖杯、舞台、排行榜用同一套光效和材质语言，避免页面拼贴感。手机预览是最终验收标准。",
	...
	},
	{
		...
		summary: "以 AI 辅助生成神域主视觉，再由设计精修整合。诸神黎明一期 & 二期活动上线 2 天流水 90 万，一期总计流水 500 万。",
		role: "主视觉 / AIGC 工作流",
		recap: "工作流拆成：设计师出思路 → AI 出素材 → 精修字体与结构 → 分层整合。基调层、核心层、互动层分开，避免 AI 图直接上线导致的按钮和信息层级失控。",
	...
	},
	{
		...
		summary: "青春有你第二季节点。红金国风 CP 向，从开屏插画、亲密度榜到奖励规则页，把古风叙事铺进互动流程。",
		role: "活动视觉 / 插画整合",
		recap: "国风活动最容易做成「一张插画 + 表单」。这次把卷轴、灯笼、亲密度模块和规则页做成同一套材质，让滑动本身像在翻一封请柬。"
	},
	{
		...
		summary: "以设计视角做部门对外账号。完成内容推送 11 篇，累计阅读 8000+，内容归拢至总部知识库。",
		role: "策划 + 视觉 + 编辑",
		recap: "设计师账号不能只发作品。选题落在方法论、资讯和技能课，用内容反哺团队审美，也把个人影响力沉淀进组织。",
	...
	},
	{
		...
		summary: "打造快设计初级 / 进阶学习手册、视频教程与视觉宣传，完成模版制作、收集与修订 100+。",
		role: "视觉 + 教程体系",
		recap: "B 端模版要的是可复用，不是炫技。把操作路径做成手册和视频，让非设计岗位也能出图，覆盖人群 1800+，模版下载 2000+。",
	...
	},
	{
		...
		summary: "春日砸蛋玩法页。绿野仙境配色，金蛋、花环、排行榜和任务闭环完整，后续同步输出 Party Star 粉紫版本。",
		role: "活动视觉",
		recap: "同一套玩法骨架可以换皮到完全不同的情绪。绿色森系和粉紫派对是一次「结构复用 + 主题重做」的对照。"
	},
	{
		slug: "qixi-meet",
		category: "ops",
		...
		summary: "海外社交产品七夕活动。粉白恋爱视觉，摇骰子玩法，标题同步葡语 / 阿语 / 泰语等多语言。",
		role: "活动视觉 / 多语言适配",
		recap: "海外活动的炸弹是文案长度。主标题做成可替换图层，插画和按钮区预留膨胀空间，避免阿语和泰语把版面撑穿。"
	},
	{
		slug: "pati-monopoly",
		category: "ops",
		...
		summary: "夏日海岛大富翁。棋盘、骰子、排行榜、商店兑换做成同一套度假视觉，韩语主 KV 同步输出。",
		role: "活动视觉",
		recap: "棋盘类玩法信息密度高，必须先保证格子可读，再堆装饰。建筑停留弹窗用卷轴，避免和主棋盘抢色。"
	},
	{
		...
		summary: "海外万圣节节点。南瓜转盘、鬼屋奖励、多语言标题和边框物料一次出齐。",
		role: "活动视觉 / 物料",
		recap: "节日活动要「一眼节日」。南瓜、蝙蝠、墓碑是符号，转盘和榜单才是转化。符号服务玩法，而不是相反。"
	},
	{
		slug: "singing-party",
		category: "ops",
		...
		summary: "唱歌 PK 赛事。蓝紫渐变舞台、水晶徽章和仰视构图，把用户拖进演唱会现场。另附一批跨主题运营 H5 合集。",
		role: "活动主视觉",
		recap: "关键词是游戏向、娱乐感、潮流市场。四个词：蓝紫渐变、唱歌场景、兴奋氛围、轻质感。中心构图 + 透视标题，是为了让主播愿意拿去当房间背景。"
	},
	{
		slug: "feed-ads",
		category: "growth",
		...
		summary: "日常长图 / 电商图高效保质交付。团队内 8 次月度优秀设计师，均分稳定前 5。投放向视频产出 10 个消耗达 20 万的素材，其中 2 个超 50 万。",
		role: "视觉执行 / 投放创意",
		recap: "信息流不是海报。卖点要按滑动节奏拆层：头三屏抓注意力，中段讲证据，尾屏给行动。视觉服务于消耗，而不是作品集自嗨。",
	...
	},
	{
		...
		summary: "把 Stable Diffusion 与 Midjourney 嵌进真实交付：礼物、道具、头像框、霸屏、海报和运营 H5。",
		role: "设计方法建设",
		recap: "AI 不是一键出图。有效的是「关键词 / 线稿 / 风格分工 → 精修字体结构 → 分图层融合」。没有精修环节的 AI 图，进不了商业页。"
	},
	{
		slug: "social-props",
		category: "social",
		...
		summary: "黑天鹅、冰雪、软糖、女神节、梦幻、中秋等头像框套装，以及飘屏、勋章和称号条。",
		role: "道具设计",
		recap: "功能属性要在圆形头像和窄条飘屏里依然能被识别。材质和主题符号必须「缩到 80px 还认识」，否则房间里就是一块脏色。"
	},
	{
		slug: "live-gifts",
		category: "social",
		...
		summary: "3 升级花朵礼盒、全屏礼物动画、4 升级龙及多套角色向礼物。覆盖谁是凶手、皮队友、VEEKA、Starify 等。",
		role: "礼物 / 插画",
		recap: "礼物是付费情绪。升级路径要让每一档都「看起来更贵」，而不是同一张图换个颜色。动态全屏礼物用分层动画预留，便于后续动效接入。"
	},
	{
		slug: "hand-drawn",
		category: "draw",
		...
		summary: "早教英语班、少儿音乐暑假班等手绘 banner / 首图 / 长图，以及扁平场景、食物和装饰框等元素库。",
		role: "插画 / 平面",
		recap: "招生类手绘要可爱但不能幼稚到失去家长信任。配色先定主色占比，人物比例故意放大表情，信息模块用贴纸感贴上，避免插画把文字吃掉。"
	},
	{
		slug: "c4d-objects",
		category: "draw",
		...
		tags: ["C4D", "三维"],
		summary: "Walkman、打字机、游戏机临摹，以及小卡车、积木鸭等场景造型，补三维基本功。",
		role: "三维练习",
		recap: "三维不是主职，但是补观察力的手段。临摹电子产品是为了把倒角、材质和投影看清楚，再反哺 2D 质感。"
	}
];
var nav = [
	{
...
var featured = projects.filter((p) => p.featured);
function SiteHeader() {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("header", {
		className: cn("fixed inset-x-0 top-0 z-50 transition-[background,border-color,backdrop-filter] duration-200", scrolled ? "border-b border-white/10 bg-background/80 backdrop-blur-xl" : "bg-transparent"),
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			className: "shell flex h-16 items-center gap-4 lg:h-[72px]",
			children: [
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Link, {
					to: "/",
					className: "flex shrink-0 items-center gap-2 text-sm font-semibold",
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
						className: "grid size-8 place-items-center rounded-lg bg-primary text-[11px] font-black text-white",
						children: "CJ"
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("a", {
					...
					className: "ml-auto inline-flex items-center gap-1.5 rounded-full bg-hot px-3.5 py-1.5 text-xs font-bold text-white shadow-[0_8px_24px_-8px_rgba(255,51,85,0.95)] md:ml-0",
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Sparkles, { className: "size-3.5" }), "期待面试"]
				})
			]
		})
	});
}
var styles_default = "/assets/styles-CM851oWH.css";
var APP_NAME = "陈静怡 · 视觉设计作品集";
var Route$4 = createRootRoute({
	head: () => ({
		meta: [
			...
			{
				name: "description",
				content: "陈静怡视觉设计作品集。7年商业视觉，字节 / 腾讯相关项目经历，现汇量科技海外大型项目视觉。"
			},
			{
				name: "theme-color",
				content: "#05060a"
		...
		links: [
			...
			{
				rel: "stylesheet",
				href: "https://fonts.googleapis.com/css2?family=IBM+Plex+Mono:wght@400;500&family=Noto+Sans+SC:wght@400;500;600;700;900&family=Playfair+Display:ital,wght@0,500;0,700;1,500&display=swap"
			},
			{
				rel: "stylesheet",
				href: styles_default
...
var $$splitComponentImporter$2 = () => import("./routes-BNnrC9Ij.mjs");
var Route$3 = createFileRoute("/")({ component: lazyRouteComponent($$splitComponentImporter$2, "component") });
var $$splitComponentImporter$1 = () => import("./login-DyknPwky.mjs");
var Route$2 = createFileRoute("/login")({ component: lazyRouteComponent($$splitComponentImporter$1, "component") });
var $$splitComponentImporter = () => import("./work._slug-DSsfIPo_.mjs");
var Route$1 = createFileRoute("/work/$slug")({ component: lazyRouteComponent($$splitComponentImporter, "component") });
/**
...
//#endregion
export { timeline as _, getBaseURL as a, categories as c, profile as d, projects as f, stats as g, skills as h, PACKAGE_VERSION as i, featured as l, roles as m, GROK_PROVIDERS as n, Route$1 as o, projectsIn as p, GENERIC_OAUTH_ERROR_CODES as r, bio as s, router_exports as t, getProject as u, cn as v };
